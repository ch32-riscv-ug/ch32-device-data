...
| 表示（G系） | 12 | 0 |
| 既知の穴（F系） | 51 | 8（下の F 台帳で ✅ が付いていない行の数。資料側の記録が F-7・F-33・F-43〜46・F-51。F-4 と F-24 は残りだけが資料側で実害なし。**ツール側の穴は1**——F-60（V407 の FSMC_NADV 格子読みが zh/en で割れる。2026-09-04 に en 版 RM が加わって発生・記録のみ）。F-57・F-58 は 2026-08-29、F-59 は 2026-09-04 に解決） |
