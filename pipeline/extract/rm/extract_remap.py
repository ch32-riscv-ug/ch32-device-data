...
# で3種だけで、どれもその pad の pin 表にちょうど1つ対応する signal が居る——
# `ADC1_ETRGINJ` は `ADC_IETR`／`AETR2`（＝`ADC1_IETR`）、`ADC1_ETRGREG` は
# `ADC_RETR`／`AETR`（＝`ADC1_RETR`）、`ADC1_ETRGIN`（CH32M030 だけ。規則と注入を
