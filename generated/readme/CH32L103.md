...
| 通信接口 CAN | 1 | 1 | 1 | 1 | 1 | 1 |
| 通信接口 CAN FD | √ | - | - | - | √ | - |
| 通信接口 I2C | 2 | I2C1 | 2 | 2 | I2C1 | I2C1 |
| 通信接口 PDUSB USB HostDevice | HostDevice | Device | HostDevice | HostDevice | HostDevice | HostDevice |
| 通信接口 PDUSB USB PDType-C | DRPSourceSink | DRPSourceSink | DRP/Source/Sink, built-in Rd(1) | DRPSourceSink | DRP/Source/Sink, built-in Rd(1) | DRP/Source/Sink, built-in Rd(1) |
| 通信接口 SPI | 2 | SPI1 | 2 | 2 | SPI1 | SPI1 |
| 通信接口 USART | 4 | 4 | 4 | 4 | 4 | 4 |
| CPU主频 | Max：96MHz | Max：96MHz | Max：96MHz | Max：96MHz | Max：96MHz | Max：96MHz |
...
| OPA | 1 | 1 | 1 | 1 | 1 | 1 |
| 额定电压 | 3.3V | 3.3V | 3.3V | 3.3V | 3.3V | 3.3V |
| RTC | √ | √ | √ | √ | √ | √ |
| Timer Advanced-control TIM1(16-bit) | 1 | 1 | 1 | 1 | 1 | 1 |
| Timer General-purpose TIM2/3(16-bit) | 2 | 2 | 2 | 2 | 2 | 2 |
| Timer General-purpose TIM4(32-bit) | 1 | 1 | 1 | 1 | 1 | 1 |
| Timer Low-powertimer(LPTIM) | √ | √ | √ | √ | √ | √ |
| Timer SysTick(64-bit) | √ | √ | √ | √ | √ | √ |
