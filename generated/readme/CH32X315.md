...
|---|---|---|---|---|
| CH32X305 | PA13 | PA14 | AF (12 pads, see Pin definitions) | AF (13 pads, see Pin definitions) |
| CH32X315 | PA13 | PA14 | AF (13 pads, see Pin definitions) | AF (14 pads, see Pin definitions) |
...
| ADC ADC1 channel | 8+1 | 12+1 | 12+1 |
| ADC ADC2 channel | 6 | 12 | 12 |
| ADC ADC3 channel | 8 | 12 | 12 |
| ADC ADC4 channel | 6 | 12 | 12 |
| ARGB | 1 | 1 | 1 |
| Code FLASH (Bytes) | 480K(1) | 480K(1) | 480K(1) |
| CPU main frequency | Max: 480MHz | Max: 480MHz | Max: 480MHz |
| I2C | 2 | 2 | 2 |
| PDUSB USBHS(USB2.0) | Host/Device | Host/Device | Host/Device |
| PDUSB USBPD | 1 | 1Built-in Rd(2) | 1 |
| PDUSB USBSS(USB3.0) | Device | Device | Device |
| RTC | Support | Support | Support |
| SPI | 3 | 3 | 3 |
| Timer Advanced-control (16-bit) | 1 | 1 | 1 |
| Timer General-purpose(16-bit) | 2 | 2 | 2 |
| Timer General-purpose(32-bit) | 1 | 1 | 1 |
| Timer SysTick (32-bit) | Support | Support | Support |
