...
| | CH32H417&#8203;MEU6&#8203;(QFN88) | CH32H417&#8203;QEU6&#8203;(QFN128) | CH32H417&#8203;WEU6&#8203;(QFN68) |
|---|---|---|---|
...
| DFSDM | 1 | 1 | 1 |
| DVP | 1 | 1 | 1 |
| Ethernet(5) | MAC+10/100MPHY | MAC+10/100M PHY | MAC+10/100M PHY |
| FMC | 1(2) | 1 | 1(2) |
| GPHA | 1 | 1 | 1 |
| HSADC | 1 | 1 | 1 |
| I2C | 4 | 4 | 4 |
...
| PC10 | LTDC_HSYNC（AF15） | - | - | - | LTDC_B1 | SWPMI_RX | - | DVP_D8 | LTDC_R2 | LTDC_HSYNC | TIM9_CH2 | - | - | - | I2S3_CK, SPI3_SCK | USART3_TX | USART6_TX | QSPI1_SIO1 |
...
| PC1 | ADC_IN11, HSADC_IN1 | TIM8_CH1N | - | - | - | - | - | - | - | TIM5_CH1 | - | - | - | - | - | - | - | - | - | - |
...
| PC10 | LTDC_HSYNC（AF15）, SDMMC_D2 | - | - | LTDC_B1 | SWPMI_RX | - | DVP_D8 | LTDC_R2 | LTDC_HSYNC | TIM9_CH2 | - | - | - | I2S3_CK, SPI3_SCK | USART3_TX | USART6_TX | QSPI1_SIO1 | - | SDMMC_CMD, SDMMC_STS | SDMMC_CMD, SDMMC_STS |
...
| Pad | default | (no route stated) | af-0 | af-1 | af-10 | af-11 | af-12 | af-13 | af-14 | af-15 | af-2 | af-3 | af-4 | af-5 | af-6 | af-7 | af-8 | af-9 | remap-1 | remap-2 | remap-3 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| PB2 | CMP_P1 | - | - | - | - | - | FSMC_D31, SDRAM_D31 | TIM11_ETR | - | - | - | - | DFSDM_CKIN1 | TIM12_CH2 | SAI_SD_A |  I2S3_SD, I2S3_SD, SPI3_MOSI | - | QSPI1_SCK | - | - | - |
...
| PB14 | D, S, UHSIF_PORT15 | - | FSMC_A23, SDRAM_A9 | TIM1_CH2N | ETH_PHY_LED4 | QSPI2_SIOX1 | FSMC_A14, SDRAM_BA0 | USART7_CK | LTDC_CLK | DVP_VSYNC, VP_VSYNC | TIM9_CH1 | TIM8_CH2N | USART1_TX | SPI2_MISO | LTDC_G0 | USART3_RTS | USART6_RTS | DIO_D0, SDIO_D0 | - | - | - |
...
| PC1 | ADC_IN11, HSADC_IN1, LT | - | TIM8_CH1N | ETH_MDIO | QSPI2_SCSXN | SDIO_CK | - | - | DC_G5, LTDC_G5 | SDRAM_WE_N | TIM5_CH1 | DFSDM_DATIN0 | FSMC_D5 | I2S2_SD, SPI2_MOSI | - | PIOC_IO0, SAI_SD_A | - | I2C2_SDA | UHSIF_PORT3 | UHSIF_PORT0 | UHSIF_PORT0 |
...
| PC6 | D, SDMMC_D6, UHSIF_PORT25 | - | SDRAM_D6 | - | - | SWPMI_IO | RGMII_RXD3 | DVP_D0, VP_D0 | LTDC_HSYNC | - | TIM3_CH1 | TIM8_CH1 | FSMC_D8 | I2S2_MCK, SPI2_MCK | - | USART4_TX | - | SDIO_D6 | SDMMC_D6 | - | - |
...
| PC10 | LTDC_HSYNC（AF15）, SDMMC_D2, UHSIF_PORT32 | - | FSMC_NBL2, SDRAM_DQM2 | SDRAM_RAS_N | LTDC_B1 | SWPMI_RX | - | DVP_D8 | LTDC_R2 | - | TIM9_CH2 | SDRAM_D24 | - | - | I2S3_CK, SPI3_SCK | USART3_TX | USART6_TX | QSPI1_SIO1 | - | SDMMC_CMD, SDMMC_STS, UHSIF_PORT32 | SDMMC_CMD, SDMMC_STS, UHSIF_PORT32 |
| PC11 | D, SDMMC_D3, UHSIF_PORT33 | - | FSMC_NBL1, SDRAM_DQM1 | - | - | - | - | DVP_D4, VP_D4 | LTDC_B4 | LTDC_VSYNC | TIM9_CH4 | SDRAM_D25 | - | - | SPI3_MISO | USART3_RX | USART6_RX | QSPI1_SCSXN | - | SDMMC_STR, UHSIF_PORT33 | SDMMC_STR, UHSIF_PORT33 |
...
| PD7 | UHSIF_PORT42 | UHSIF_PORT42_ | - | - | - | - | - | - | - | - | - | SDRAM_CS_N1 | USART5_RTS | SPI1_MOSI | DFSDM_CKIN1 | USART2_CK | - | - | - | SDMMC_D7 | SDMMC_D7 |
...
| PD11 | I2, UHSIF_PORT17 | - | SDRAM_A11 | LPTIM1_ETR | RGMII_TXD2 | LTDC_R4 | FSMC_A16 | - | USART1_CK | - | - | LPTIM2_CH2 | C4_SMBA, I2C4_SMBA | - | TIM5_ETR | USART3_CTS | - | QSPI1_SIO0 | SDMMC_SDCK, SDMMC_SLVCK | - | - |
...
| PD13 | D, UHSIF_PORT19 | - | SDRAM_D0 | LPTIM1_OC | RGMII_TXD0 | - | FSMC_A18 | DVP_D5, VP_D5 | USART1_TX | - | TIM4_CH2 | LTDC_R2 | I2C4_SDA | CAN3_TX | TIM5_CH2 | - | - | QSPI1_SIO3 | - | - | - |
...
| PE7 | OPA2_OUT0, SD, UHSIF_PORT2 | - | - | TIM1_ETR | QSPI1_SIOX0 | - | FSMC_D4, RAM_D4, SDRAM_D4 | - | - | - | - | - | - | - | - | USART8_RX | - | - | UHSIF_PORT2 | - | - |
...
| PE10 | SD, UHSIF_PORT5 | - | - | TIM1_CH2N | QSPI1_SIOX3 | - | FSMC_D7, RAM_D7, SDRAM_D7 | - | - | SDRAM_BA1 | - | SDRAM_D17 | - | - | - | QSPI2_SCK | SDIO_D2 | - | - | UHSIF_PORT5 | UHSIF_PORT5 |
...
| PF8 | HSADC_IN4, SD | - | - | - | QSPI1_SIO0 | - | FSMC_D20, RAM_D20, SDRAM_D20 | TIM11_CH3 | - | - | - | SPI1_MOSI | QSPI2_SIO0 | - | SAI_SCK_B | USART8_RTS | QSPI2_SIO0 | TIM10_CH1 | - | - | - |
| PF9 | HSADC_IN5 | - | - | - | QSPI1_SIO1 | USART8_RTS | FSMC_D21, SDRAM_D21 | TIM11_CH4 | - | - | - | SPI1_MISO | QSPI2_SIO1 | - | SAI_FS_B | USART8_CTS | - | TIM10_CH2 | - | - | - |
| PF10 | HSADC_IN6, S | - | - | - | - | USART8_CTS | DRAM_D22, FSMC_D22, SDRAM_D22 | DVP_D11 | LTDC_DE | - | - | - | QSPI2_SIO2 | - | - | USART8_CK | TIM10_ETR | - | - | - | - |
