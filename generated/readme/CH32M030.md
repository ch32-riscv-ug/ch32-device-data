...
| CMP3 | 1 | 1 | 1 | 1 | 1 |
| 通信接口 I2C | 1 | 1 | 1 | 1 | 1 |
| 通信接口 PDUSB USB PDType-C | (CC1,CC2)(CC3,CC4) | (CC1R,CC2R)(CC3,CC4), built-in Rd(1) | (CC1R,CC2R)(CC3,CC4), built-in Rd(1) | (CC3,CC4) | (CC1R,CC2R)(CC3,CC4), built-in Rd(1) |
| 通信接口 PDUSB USBFS | HostDevice | HostDevice | HostDevice | HostDevice | HostDevice |
| 通信接口 SPI | 1 | 1 | 1 | - | 1 |
| 通信接口 UART | 1 | 1 | 1 | 1 | 1 |
...
| 信号解码QII | 2 | 2 | 2 | 1 | 1 |
| Timer Advanced-controlTIM1 (16-bit) | 1 | 1 | 1 | 1 | 1 |
| Timer General-purposeTIM2 (16-bit) | 1 | 1 | 1 | 1 | 1 |
| Timer Streamlined TIM3(16-bit) | 1 | 1 | 1 | 1 | 1 |
| Timer System time base(32-bit) | √ | √ | √ | √ | √ |
| Timer WWDG | 1 | 1 | 1 | 1 | 1 |
