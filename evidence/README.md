...
| `af-N` | The AF number is written alongside in the same column (`SDA(AF7)`) | Write N to that pad's AF number | No | 4,530 |
...
**Where to write the AF number.** The destination of the N in `route = af-N` (4,530 rows) of `pin_functions.csv`,
