...
attached -- 32 tables ([docs/data-layout.ja.md](../docs/data-layout.ja.md) (Japanese)). Spelling is kept as in the original:
...
Clocks and operating voltages per series. Generated by `tools/build_operating.py`.
...
uv run tools/build_operating.py                 # operating_conditions (takes a few minutes)
