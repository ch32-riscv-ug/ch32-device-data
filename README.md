...
| [`evidence/`](evidence/README.md) (34 tables) | what the documents say, **spelled as they spell it**, every row with its provenance (`basis`) and confidence (`confidence`) | anyone checking correctness |
