...
| [`evidence/`](evidence/README.md) (32 tables) | what the documents say, **spelled as they spell it**, every row with its provenance (`basis`) and confidence (`confidence`) | anyone checking correctness |
