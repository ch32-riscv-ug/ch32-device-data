...
#
#   ~~I2S3_*~~  CH32V303/305/307/317 の35行は 2026-08-28 に解消（F-6）。「V30x の RM
...
COLUMN_SOURCES: dict[str, tuple[str, str]] = {
    ...
    "clock_enables": ("extract_clock_enables.py", "COLUMNS"),
    ...
    "debug_data": ("extract_debug_data.py", "COLUMNS"),
    ...
    "register_fields": ("extract_registers.py", "FIELD_COLUMNS"),
    "registers": ("extract_registers.py", "REGISTER_COLUMNS"),
    ...
    "timers": ("extract_timers.py", "COLUMNS"),
    "toolchains": ("build_toolchains.py", "COLUMNS"),
    "usbpd_plumbing": ("extract_usbpd_plumbing.py", "COLUMNS"),
    ...
    "index:register_layouts": ("extract_registers.py", "LAYOUT_COLUMNS"),
