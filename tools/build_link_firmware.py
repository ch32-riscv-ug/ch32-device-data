...
**版を名乗るものが3つあり、意味が違う**（読み方は下で決着している）:
...
**ただしこの式は minor が16以上で壊れます**（`42` を「3.6」と表示する）。実機の
申告値と突き合わせた結論は下の `BASE_MAJOR` の註にあるとおり **`wcfg = major*10 + minor`**
で、`31`→2.11、`32`→2.12、`34`→2.14、`42`→**2.22**。表に載せるのはこちらです。
